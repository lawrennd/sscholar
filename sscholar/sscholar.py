...
def query(searchstr, allresults=False):
    ...
    This method queries semantic scholar and returns a list of citations.
    ...
    url = SEMANTIC_SCHOLAR_URL + searchstr
    header = HEADERS
    ...
    # grab the links
    # tmp = get_s2(html, outformat)
    print(html)

    #return result


def get_s2(html, outformat):
    """Return a list of S2 references from the html.
...
def pdflookup(pdf, allresults, outformat, startpage=None):
    """Look a pdf up on semantic scholar and return bibtex items.
